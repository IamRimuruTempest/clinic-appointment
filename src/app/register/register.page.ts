...
export class RegisterPage implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    await regionByCode('01').then((region: any) =>
      console.log(region.region_name)
    );
    await provinces('01').then((province: any) => console.log(province));
    await provincesByCode('01').then((province: any) => console.log(province));
    await provinceByName('Rizal').then((province: any) =>
